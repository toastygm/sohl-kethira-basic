...
sohl:
  items:
    ...
    - { model: skill-chrm, system: { masteryLevelBase: 24 } }
    - { model: skill-cmd, system: { masteryLevelBase: 18 } }
    - { model: skill-dscr, system: { masteryLevelBase: 24 } }
    - { model: skill-guil, system: { masteryLevelBase: 32 } }
    ...
    - { model: skill-draw, system: { masteryLevelBase: 11 } }
    ...
    - { model: skill-ridg, system: { masteryLevelBase: 9 } }
